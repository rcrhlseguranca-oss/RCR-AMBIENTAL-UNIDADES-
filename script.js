...
const baseDeDadosLinks = {
    'TABOÃO DA SERRA-SP': {
        ...
        ocorrencias: "https://link-seguranca-taboao.com",
    ...
    'HORTOLANDIA-SP': {
        ...
        equipamentos: "https://drive.google.com/drive/folders/1PbRgB7QbY9kyRDPgywkTRN4TeBtqyrWU?usp=sharing",
...
function openUnidade(nomeUnidade) {
    ...
    if (links) {
		...
		document.getElementById('link-checklist').href = links.checklist;
       document.getElementById('link-liberacao').href = links.liberacao;
       document.getElementById('link-ocorrencias').href = links.ocorrencias;
       document.getElementById('link-chaves').href = links.chaves;
       document.getElementById('link-controle-veic').href = links.controleVeic;
